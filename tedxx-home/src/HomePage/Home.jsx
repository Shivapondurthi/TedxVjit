  ...
  />
    ...
    <div class="hero-content">
        <div class="text-overlay">
            <h1 class="heading-pop"> POWER OF <em class="red-text-heading">PERSISTENCE</em></h1>
            <p class="paragraph-pop">The theme " Power of <em class="red-text">Persistence</em>" 
            represents the strength and dedication needed to overcome 
            obstacles and achieve greatness.</p>
            <a href="#" class="learn-more-btn">LEARN MORE →</a>
        </div>
    </div>
</section>

      <section className="about-section reveal" id="discover">
        <img className="img-fluid w-50 about-illustration" src="Resources/Images/HomePage/about-illustration.png" alt="About Illustration" />
        <div className="container">
          <div className="row align-items-center-md justify-content-evenly-md">
            <div className="col-lg-7">
              <div className="about-section-content">
                <div className="container mx-auto">
                  <div className="about-heading">
                    <div style={{ display: "flex" }}>
                      <p style={{ fontSize: "30px", marginTop: "15px" }}>What is</p>
                      <img style={{width: '200px', height: '40px', marginTop: '18px', marginLeft: '10px'}}
                        className="img-fluid about-logo"
                        src="vjitmedia/TEDxVJIT_Navbar_About.png"
                        alt="TEDx VJIT"
                      />
                    </div>
                  </div>
                ...
                <div className="container mx-auto ">
                  <div className="text-box text-center">
                    <p className="py-1" style={{ textAlign: "justify", fontSize: "20px", fontWeight: 300}}>
                    ...
                    <h3 className="wevjit" style={{ color: "#EB0028", fontSize: "35px" }}>We The VJIT . . .</h3>
                    <p className="py-1" style={{ textAlign: "justify", fontSize: "20px", fontWeight: 300 }}>
